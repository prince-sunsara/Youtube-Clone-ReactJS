  ...
  return (
    <Link to={`/video/${video.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
        ...
        <div className="flex flex-col overflow-hidden ml-4 md:ml-6 mt-4 md:mt-0">
          {/* video title  */}
          <span className="text-white/[0.85] text-lg md:text-2xl font-semibold line-clamp-2">
            {video?.title}
          </span>
          {/* video description  */}
